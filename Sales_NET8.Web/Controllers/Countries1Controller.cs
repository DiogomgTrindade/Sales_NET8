...
{
    public class Countries1Controller : Controller
    {
        private readonly DataContext _context;

        public Countries1Controller(DataContext context)
        {
            _context = context;
        }
        ...
        // GET: Countries1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Countries1/Create
